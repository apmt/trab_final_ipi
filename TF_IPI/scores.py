# Calculos de qualidade do algoritmo (sem textura):
# Input - output(dir)
# Output - no_texture.jpeg(file)
import os
import glob
import shutil
import numpy as np
...
# Para todas as imagens processadas (sem textura):
...
axs[0].bar(keys, qualidade.values(), color="green")
...
# Salva os graphs
plt.savefig('no_texture.jpeg')

#Finalizations do algoritmo
print "Graph of no_texture scores on current diretory"
try:
	shutil.rmtree('./aux')
except OSError:
